...
const Map<String, String> _legacyLabels = {
  ...
  'GRANDPARENT': '祖辈',
  'SIBLING': '兄弟姐妹',
  'IN_LAW_PARENT': '公婆/岳父母',
  'IN_LAW_GRANDPARENT': '祖辈（姻亲）',
};
...
const Map<String, String> _inverseSuggestions = {
  ...
  'DAUGHTER_IN_LAW': 'IN_LAW_PARENT',
  'SON_IN_LAW': 'IN_LAW_PARENT',
  'GRANDSON_WIFE': 'IN_LAW_GRANDPARENT',
  'GRANDDAUGHTER_HUSBAND': 'IN_LAW_GRANDPARENT',
  'IN_LAW_PARENT': 'DAUGHTER_IN_LAW',
  'IN_LAW_GRANDPARENT': 'GRANDSON_WIFE',
